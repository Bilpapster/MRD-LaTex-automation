...
def read_input_file(path):
    ...
    for i in df.index:
        ...
        image = 'content_input/' + str(df['PhotoFilePath'][i])
...
input_path = prefix + "content_input/content_file.csv"
content_dict = read_input_file(input_path)

environment = jinja2.Environment(
    loader=jinja2.PackageLoader(prefix + "make_content"),
...
with open(prefix + 'resulting_slides/slides.tex', 'w') as file:
    file.write(result)
